...
export class Contact implements Serializable<Contact> {
  ...
  update(apikey: string, jsonApiService: JsonApiService, contName?: string) {
    ...
    return jsonApiService.UpdateRecFun(apikey, 'Contact', recordId, ContactRecordData,'Edit',contName);
