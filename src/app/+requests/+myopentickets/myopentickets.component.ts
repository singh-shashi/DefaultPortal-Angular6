...
export class MyOpenTicketsComponent implements OnInit {
  ...
  // "Agent Queue,Analyst Responded,Customer Responded,Enhancement Request,Group Queue,
  // Sustainment,Tier 3 Triage,Waiting Analyst Reply,Waiting Customer Reply,Customer Responded,
  // Reopened,Waiting Customer Verification,Tier 3 Complete,JIRA Waiting Reply";
